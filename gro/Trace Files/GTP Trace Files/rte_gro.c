 ...
 */
		 ...
		 const struct rte_gro_param *param)
 {
	 ...
	 for (i = 0; i < nb_pkts; i++) {
		  ...
		  */
		  /* Trace macro values for monitoring */
		 ...
		 rte_gro_trace_macro_values_reassemble_burst(ptype, is_ipv4_tcp, is_ipv6_tcp,
				 is_ipv4_udp, is_ipv4_vxlan_tcp4, is_ipv4_vxlan_udp4,
				 is_ipv4_gtp_udp4, is_ipv4_gtp_tcp4);
