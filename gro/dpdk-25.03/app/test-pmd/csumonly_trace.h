...
RTE_TRACE_POINT(
	net_trace,
	RTE_TRACE_POINT_ARGS(const struct rte_net_hdr_lens *hdr_lens, uint32_t ptype),
	rte_trace_point_emit_u8(hdr_lens->l2_len);
	rte_trace_point_emit_u16(hdr_lens->l3_len);
	rte_trace_point_emit_u8(hdr_lens->l4_len);
